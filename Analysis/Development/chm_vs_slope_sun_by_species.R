# Slope of Sun effect vs canopy height
...
stats <-read_xlsx("C:/Workspace/R_Scripts/Reproducibility/data/plot_statistics_sun.xlsx")
...
PB <- ggplot(df_temp2) +
  ...
  ggtitle(paste0("Intercomparison of Plant Height and slope (sun) - Betula"))+
...
ggsave(
  ...
  filename = "output_data/plots/comparison_slope_sun_plantheight_betula.png",
  width = 16,
  height = 10,
  units = "cm"
)
...
PS <- ggplot(df_temp2) +
  ...
  theme_fancy() +
  #add title and labels
  ggtitle(paste0("Intercomparison of Plant Height and slope (sun) - Salix aurita"))+
  theme(aspect.ratio=1)+
  xlab('CHM Mean Canopy Height (m)')+
  ylab('Slope')+
  #coord_equal(ratio=1)
...
ggsave(
  PS,
  # filename = "/plots/test.png",
  filename = "output_data/plots/comparison_slope_sun_plantheight_Salix.png",
  width = 16,
  height = 10,
  units = "cm"
)
...
PU <- ggplot(df_temp2) +
  ...
  theme_fancy() +
  #add title and labels
  ggtitle(paste0("Intercomparison of Plant Height and slope (sun) - Ulex europaeus"))+
  theme(aspect.ratio=1)+
  xlab('CHM Mean Canopy Height (m)')+
  ylab('Slope')+
  #coord_equal(ratio=1)
...
ggsave(
  PU,
  # filename = "/plots/test.png",
  filename = "output_data/plots/comparison_slope_sun_plantheight_Ulex.png",
  width = 16,
  height = 10,
  units = "cm"
)
...
PF <- ggplot(df_temp2) +
  ...
  theme_fancy() +
  #add title and labels
  ggtitle(paste0("Intercomparison of Plant Height and slope (sun) - Festuca europaeus"))+
  theme(aspect.ratio=1)+
  xlab('CHM Mean Canopy Height (m)')+
  ylab('Slope')+
  #coord_equal(ratio=1)
...
ggsave(
  PF,
  # filename = "/plots/test.png",
  filename = "output_data/plots/comparison_slope_sun_plantheight_Festuca.png",
  width = 16,
  height = 10,
  units = "cm"
)
...
ggsave(
  P4,
  # filename = "/plots/test.png",
  filename = "output_data/plots/slope_sun_plant height_all_species.png",
  width = 16,
  height = 16,
  units = "cm"
)

...
P8 <- ggplot(df_temp) +
  ...
  #geom_text(aes(x=0.0,y=0.2),label=paste0('R2: ',round(r2val,2)),hjust='left',size=2.0)+
...
ggsave(
  ...
  filename = "output_data/plots/Sun/Festuca_16_plots_sun.png",
  width = 16,
  height = 16,
  units = "cm"
)
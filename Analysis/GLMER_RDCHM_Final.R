...
ggplot2::ggsave(
  P_All2_wind,
  # filename = "/plots/test.png",
  filename = paste0("output_data/full_model/Figure 3 Combined figure_wind models_RDCHM_AB.jpg"),
  width = 16,
  height = 10,
  units = "cm"
) 
...
ggplot2::ggsave(
  P12a,
  # filename = "/plots/test.png",
  filename = paste0("output_data/full_model/Figure S4 glmer_RDCHM_Illumination.jpg"),
  width = 16,
  height = 16,
  units = "cm"
) 
...
ggplot2::ggsave(
  P30a,
  # filename = "/plots/test.png",
  filename = paste0("output_data/full_model/Figure S3 glmer_wind_plant height_RDCHM_full_model.jpg"),
  width = 8,
  height = 10,
  units = "cm"
) 
...
ggplot2::ggsave(
  P_All3_illumination,
  # filename = "/plots/test.png",
  filename = paste0("output_data/full_model/Figure 4 3_panel_illumination.jpg"),
  width = 16,
  height = 8,
  units = "cm"
) 

...
idw <- read_xlsx("C:/Workspace/R_Scripts/Reproducibility/data/plot_chm_metrics_temp30.xlsx")
...
Pcompare2 <- ggplot(df) +
  geom_point(aes(x = Mn_chm, y = Mn_idw,col = colors[factor(PlotGenus)]), alpha=0.3, size = 1) +
  #  add the statistics
  geom_text(aes(x=0.0,y=3),label=paste0('MAD: ',round(MADval,3)),hjust='left',size=3.0)+
  geom_text(aes(x=0.0,y=2.8),label=paste0('R2: ',round(r2val,2)),hjust='left',size=3.0)+
  geom_text(aes(x=0.0,y=2.6),label=ccc,hjust='left', size=3.0)+
...
Pcompare3<- ggplot(df, aes(x = Mn_chm, y = Mn_idw, colour = PlotGenus)) +  geom_point()+
geom_text(aes(x=0.0,y=3),label=paste0('MAD: ',round(MADval,3)),hjust='left',size=3.0)+
  geom_text(aes(x=0.0,y=2.8),label=paste0('R2: ',round(r2val,2)),hjust='left',size=3.0)+
  geom_text(aes(x=0.0,y=2.6),label=ccc,hjust='left', size=3.0)+
  geom_text(aes(x=0.0,y=2.4),label=equation,hjust='left', size=3.0)+

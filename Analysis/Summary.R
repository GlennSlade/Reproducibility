...
df2 <- df4 %>% dplyr::select (survey,plot,Mn_chm,Wind_Av,Sun_Elev_calc, Sun_Percent, empty_prop,Wind_SD,Wind_Max)
...
# as abobe but  Sun Elevation / proportion of plot reconstructed

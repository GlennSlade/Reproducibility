...
# ------ Written for PhotoScan 1.4.3 64 bit --Revised for Metashape 1.8.5 May 2023 and RTK enabled image data------------
#######################################################################################################################
# IMPORTS #
...
def preprocess(Est_img_qual, img_qual_thresh, chunk):
    ...
    if Est_img_qual == "TRUE":
        ...
        chunk.analyzePhotos()  # changed from analyzePhotos() in Metashape 2.0
...
def filter_reproj_err (chunk, reproj_err_limit):
    ...
    print ("filtering PointCloud by reprojection error (threshold = " + str(reproj_err_limit) + ")")

...
DTM = rast("/raid/home/gs558/share/Reproducibility/Processed/DTM_interpolated/IDW/DTM_site_IDW.tif")
...
#plot(ras_mask)
writeRaster(ras_mask,paste0 ("/raid/home/gs558/share/Reproducibility/Plot/DTM/P",i,"_DTM.tif"), overwrite = TRUE )
next
}

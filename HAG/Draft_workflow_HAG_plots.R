...
S1_P45_las = readLAS("E:/Glenn/Reproducibility/Processed/LAS/Plots/S1_P45a.laz")# heres on i have already prepared
...
writeRaster(idw,"E:/Glenn/Reproducibility/Plot/S1_P45_gstat_idw.tif", overwrite = TRUE )

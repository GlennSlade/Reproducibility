...
## R Markdown Testing GLMER Model development
## All Survey data (61 Surveys)
## For Betula species only 
## 
...
## Data Prep and filtering for Betula
...
## Simple Wind Model -- Relative difference of Mean Canopy Height to Max
```{r }
...
## Simple Wind Model -- Mean Canopy Height
...
```
## Wind and Sun Elevation -- all data
```{r }
...
## Wind and sun elevation (filtered for sunny conditions)
## defined as having direct sunlight for more than 80% of the time
...
# model nearly unidentifiable large eigenvalueodel nearly unidentifiable large eigenvalue

```

## Just to check wind and sun elevation (filtered for no sun conditions)
## defined as having direct sunlight for less than 25% of the time
...
##randomised slope - intercept of sun elev for each plot - all cloud conditions
...
##Fixed effect wind with sun elevation (filtered for sunny conditions)

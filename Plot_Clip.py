...
#
# This script processes the .las point clouds generated in Metashape for each survey and clips an individual point cloud
# for each harvest plot from each survey.

...
as_tibble(Plot_data) #turns data frame in tidy tibble
view (Plot_data)
as_tibble(Survey_data) #turns data frame in tidy tibble
view (Survey_data)
as_tibble(SfM_data) #turns data frame in tidy tibble
view (SfM_data)
...
write.csv(R_data,"C:/Workspace/Reproducibility/R_data.csv")

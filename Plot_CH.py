...
# https://github.com/GlennSlade/Reproducibility
# This script imports the individual plot based point clouds for each survey derived in script Plot_Clip.py.
# The corner coordinates of the harvest plots are used to generate a delaunay TIN of the DTM of each plot.
# Height above ground is calculated as the difference between the DTM and point cloud height.
# Max canopy height is calculated for a 0.01m grid across the plot.
# Summary statistics for each plot and each survey are generated.
# Final csv data set is exported.
# Based on the work of Andrew Cunliffe <andrewmcunliffe@gmail.com>.
